...
void OpticalFlowSingleLevelMT(const cv::Mat &img1, const cv::Mat &img2,
...
int main(int argc, char **argv) {
    ...
    // compare multi thread version
    evaluate_and_call([&]() { OpticalFlowSingleLevel(img1, img2, kp1, kp2_single, success_single, false); },
                        "optical flow single level", 1);
    
    kp2_single.clear();
    success_single.clear();

    evaluate_and_call([&]() { OpticalFlowSingleLevelMT(img1, img2, kp1, kp2_single, success_single, false); },
